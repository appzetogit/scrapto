...
const ScrapperTerms = () => {
  const staticTexts = [
    'SCRAPTOX – SCRAPPER PARTNER AGREEMENT',
    'Last Updated: 01 January 2026',
    'This Agreement is between Scraptox and the Scrapper Partner.',
    'Nature of Relationship',
    'Scrappers are independent contractors',
    'This agreement does not create employment, agency, or partnership',
    'Scraptox is a technology service provider only',
    'Scope of Services',
    'Scrapper agrees to:',
    ...
    'Scraptox may revoke exclusivity for misconduct or SLA failure',
    'Ratings & Conduct',
    'Scrappers must maintain professional behavior',
    'Harassment, threats, or misrepresentation = permanent ban',
    'Scraptox may remove fake or abusive ratings',
    ...
    'Labor compliance',
    'Safety standards',
    'Scrapper indemnifies Scraptox from all penalties and claims.',
    'Dispute Resolution',
    'Scraptox may mediate disputes at its discretion.',
    "Scraptox’s decision shall be final and binding.",
    'Termination',
    'Scraptox may terminate this agreement without notice for:',
    'Fraud',
    'Repeated disputes',
    'Platform abuse',
    'Legal non-compliance',
    'Limitation of Liability',
    "Scraptox’s total liability shall not exceed subscription fees paid in the last 30 days.",
    'Governing Law',
    'Indian law applies.',
      ...
      <div className="w-full p-4 md:p-6 max-w-3xl mx-auto">
        <div className="flex items-center justify-between pb-3 md:pb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl md:text-2xl font-bold text-white">
              {getTranslatedText('SCRAPTOX – SCRAPPER PARTNER AGREEMENT')}
            </h1>
          </div>
        ...
        <div className="rounded-2xl p-4 md:p-6 shadow-lg backdrop-blur-sm bg-white/95">
          <div className="prose max-w-none text-sm md:text-base text-slate-700">
            <p>{getTranslatedText('This Agreement is between Scraptox and the Scrapper Partner.')}</p>
            ...
            <ul>
              ...
              <li>{getTranslatedText('Scraptox is a technology service provider only')}</li>
            </ul>
            ...
            <ul>
              ...
              <li>{getTranslatedText('Scraptox does not interfere in price decisions')}</li>
            ...
            <ul>
              ...
              <li>{getTranslatedText('Scraptox is not responsible for payment defaults')}</li>
            ...
            <ul>
              ...
              <li>{getTranslatedText('Scraptox may revoke exclusivity for misconduct or SLA failure')}</li>
            </ul>
            ...
            <ul>
              ...
              <li>{getTranslatedText('Scraptox may remove fake or abusive ratings')}</li>
            </ul>
            ...
            <p>{getTranslatedText('Scrapper indemnifies Scraptox from all penalties and claims.')}</p>

            <h3>{getTranslatedText('10. Dispute Resolution')}</h3>
            <p>{getTranslatedText('Scraptox may mediate disputes at its discretion.')}</p>
            <p>{getTranslatedText("Scraptox’s decision shall be final and binding.")}</p>

            <h3>{getTranslatedText('11. Termination')}</h3>
            <p>{getTranslatedText('Scraptox may terminate this agreement without notice for:')}</p>
            <ul>
            ...
            <p>{getTranslatedText("Scraptox’s total liability shall not exceed subscription fees paid in the last 30 days.")}</p>
