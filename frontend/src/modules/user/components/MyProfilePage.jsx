  ...
  return (
    <motion.div
      ...
      <div className="px-3 md:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <div
            className="rounded-xl md:rounded-2xl p-3 md:p-6 shadow-sm md:shadow-md"
            ...
            <AnimatePresence mode="wait">
              {!isEditMode ? (
                <motion.div
                  ...
                  {/* Profile Picture */}
                  <div
                    className="w-12 h-12 md:w-20 md:h-20 rounded-full flex items-center justify-center flex-shrink-0 relative"
                    style={{
                      backgroundColor: 'rgba(100, 148, 110, 0.15)',
                      border: '2px md:border-3 solid rgba(100, 148, 110, 0.3)'
                    }}
                  >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className="text-[10px] md:text-xs px-2 py-0.5 rounded-full flex items-center gap-1"
                        style={{
                          backgroundColor: 'rgba(100, 148, 110, 0.1)',
                          color: '#64946e'
                        }}
                  ...
                  <button
                    ...
                    className="p-1.5 md:p-2 rounded-lg hover:opacity-70 transition-opacity flex-shrink-0"
                    style={{
                      backgroundColor: 'rgba(100, 148, 110, 0.1)',
                      color: '#64946e'
                    }}
                ...
                <motion.div
                  ...
                  <div className="flex flex-col items-center gap-3">
                    <div className="relative">
                      <div
                        className="w-16 h-16 md:w-24 md:h-24 rounded-full flex items-center justify-center relative overflow-hidden"
                        style={{
                          backgroundColor: 'rgba(100, 148, 110, 0.15)',
                          border: '2px md:border-3 solid rgba(100, 148, 110, 0.3)'
                        }}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 md:px-4 md:py-2.5 rounded-lg text-xs md:text-base border transition-all focus:outline-none"
                      style={{
                        borderColor: '#e5ddd4',
                        color: '#2d3748',
                  ...
                  <div className="flex gap-2 md:gap-3 pt-2">
                    <button
                      ...
                      className="flex-1 py-1.5 md:py-2.5 px-3 rounded-lg font-semibold text-xs md:text-base transition-all"
                      style={{
                        backgroundColor: '#ffffff',
                    ...
                    <button
                      onClick={handleSave}
                      className="flex-1 py-1.5 md:py-2.5 px-3 rounded-lg font-semibold text-xs md:text-base text-white transition-all"
        ...
        <div className="flex gap-2 mb-3 md:mb-6 overflow-x-auto scrollbar-hide pb-1">
          {[
            ...
            <button
              ...
              className={`px-3 py-1.5 md:px-6 md:py-3 rounded-full md:rounded-lg font-semibold text-xs md:text-base whitespace-nowrap transition-all flex items-center gap-1.5 ${activeTab === tab.id ? 'text-white' : 'text-gray-600'
                }`}
              style={{
                ...
                boxShadow: activeTab === tab.id ? "0 2px 4px rgba(100,148,110,0.2)" : "none"
              }}>
                  ...
                  {[
                    ...
                    return (
                      <motion.div
                        ...
                        className="p-2 md:p-4 rounded-lg md:rounded-xl text-center"
                        style={{
                ...
                <div className="space-y-3 md:space-y-4">
                  {activityFeed.map((item, index) => (
                    <motion.div
                      ...
                      transition={{ duration: 0.3, delay: index * 0.05 }}
                      className="rounded-xl md:rounded-2xl p-3 md:p-4 shadow-sm"
                      style={{ backgroundColor: "#ffffff" }}>
